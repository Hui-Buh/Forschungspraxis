function varargout = test_gui_neu(varargin)
...
% Last Modified by GUIDE v2.5 19-Apr-2016 13:38:30
...
saliancy(1) = get(handles.slider2, 'Value');
saliancy(2) = get(handles.slider3, 'Value');
saliancy(3) = get(handles.slider4, 'Value');
saliancy(4) = get(handles.slider5, 'Value');
saliancy(5) = get(handles.slider6, 'Value');
saliancy(6) = get(handles.slider7, 'Value');
saliancy(7) = get(handles.slider8, 'Value');
saliancy(8) = get(handles.slider9, 'Value');
...
set(handles.text18, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text19, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text20, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text21, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text22, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text23, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text24, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
