...
%% Aufteilen der Bilder in faces, faces_m, faces_t und sonstige
    ...
    for a = 1:size(image_listing,1)
        ...
        || isempty(regexp(image_listing(a,1).name, '[d u][0-9]+_AOI.jpg', 'once')) == 0 ... % normal faces down faces AOI
        || isempty(regexp(image_listing(a,1).name, 'Noh_Maske_test[0-9]+_AOI.jpg', 'once')) == 0 ...
        || isempty(regexp(image_listing(a,1).name, 'front_AOI.jpg', 'once')) == 0 ...
        ...
        || isempty(regexp(image_listing(a,1).name, '[d u][0-9]+m_AOI.jpg', 'once')) == 0 ... % binary down faces AOI
        || isempty(regexp(image_listing(a,1).name, 'Noh_Maske_test[0-9]+_m_AOI.jpg', 'once')) == 0 ...
        || isempty(regexp(image_listing(a,1).name, 'frontm_AOI.jpg', 'once')) == 0 ...
        ...
        || isempty(regexp(image_listing(a,1).name, '[d u][0-9]+t_AOI.jpg', 'once')) == 0 ... % binary upside down faces AOI
        || isempty(regexp(image_listing(a,1).name, 'Noh_Maske_test[0-9]+_t_AOI.jpg', 'once')) == 0 ...
        || isempty(regexp(image_listing(a,1).name, 'frontt_AOI.jpg', 'once')) == 0 ...
