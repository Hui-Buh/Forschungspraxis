...
% Last Modified by GUIDE v2.5 12-Apr-2016 13:50:53
...
global dauer bilder durchlauf kontroll_kennung patient_kennung data_path image_path Sakka_Sakkd_Fix Sakk_p_Sakk_grad_mean_max Sakkpx_Sakkgrad
...
global dauer bilder durchlauf kontroll_kennung patient_kennung data_path image_path Sakka_Sakkd_Fix 
% hObject    handle to pushbutton1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
get_parameters(hObject, eventdata, handles)
set(handles.text9, 'String', cat(2, 'Estimated time: ', num2str(dauer(1))));
tic
...
global dauer bilder durchlauf kontroll_kennung patient_kennung data_path image_path
...
global dauer bilder durchlauf kontroll_kennung patient_kennung data_path image_path Sakk_p_Sakk_grad_mean_max
