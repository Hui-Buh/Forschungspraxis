...
% Last Modified by GUIDE v2.5 19-Apr-2016 16:12:20
...
saliency(1) = get(handles.slider2, 'Value');
saliency(2) = get(handles.slider3, 'Value');
saliency(3) = get(handles.slider4, 'Value');
saliency(4) = get(handles.slider5, 'Value');
saliency(5) = get(handles.slider6, 'Value');
saliency(6) = get(handles.slider7, 'Value');
saliency(7) = get(handles.slider8, 'Value');
saliency(8) = get(handles.slider9, 'Value');
...
if closeall == 1; try close Figure 1; close Figure 2; close Figure 3; catch; end; end;
disp('start Function');
evaluate_saliency( bilder, durchlauf, saliency , kontroll_kennung, patient_kennung, data_path, image_path)
disp('Finished');
...
set(handles.text26, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
...
set(handles.text29, 'String', cat(2,num2str(round(get(hObject,'Value')*100)), '%'));
